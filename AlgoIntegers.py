...
def bucket_sort(arr):
    ...
    for num in arr:
        ...
        index = min((num - min_val) * num_buckets // bucket_range, num_buckets - 1)
...
def generate_input(scenario, n):
    if scenario == 1:
        ...
        return [random.randint(0, int(log2(n))) for _ in range(n)]
    elif scenario == 5:
...
# Scenario tiles for graph title
scenario_titles = {
    1: 'n randomly chosen integers in the range [0....n]',
    2: 'n randomly chosen integers in the range [0...k], k < 1000',
    3: 'n randomly chosen integers in the range [0....n³]',
    4: 'n randomly chosen integers in the range [0.....log n]',
    5: 'n integers multiples of 1000 in range [0....n]',
    6: 'In-order integers [0...n] with [(log n)/2] randomly swapped values'
}
# Default input sizes
